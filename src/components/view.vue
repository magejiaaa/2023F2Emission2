...
export default {
    setup() {
        ...
        function removeCommas(data) {
            ...
            } else if (typeof data === 'object' && data !== null) { // 如果是物件
                    ...
                    .then(blob => {
                        ...
                        reader.onload = e => {
                            ...
                            workbook.SheetNames.forEach(sheetName => {
                                ...
                                cityName.value = cityData.map(item => item.第15任總統副總統選舉候選人得票數一覽表.replace(/　/g, ''));
